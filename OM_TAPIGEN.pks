...
c_true_enable_col_camel        CONSTANT BOOLEAN := TRUE;
c_false_enable_col_camel       CONSTANT BOOLEAN := FALSE;
c_true_col_camel               constant varchar2(1) := '"';
c_false_col_camel              constant varchar2(1) := '';
c_false_enable_prefix_fnc_prc  CONSTANT BOOLEAN := FALSE;
c_true_enable_prefix_fnc_prc   CONSTANT BOOLEAN := TRUE;
c_true_prefix_fnc              constant varchar2(4) := 'fnc_';
c_true_prefix_prc              constant varchar2(4) := 'prc_';
c_false_prefix                 constant varchar2(4) := '';
...
TYPE t_rec_existing_apis IS RECORD(
  ...
  p_enable_col_camel            varchar2(5 char),
  p_enable_prefix_fnc_prc       varchar2(5 char),
  p_prefix_fnc                  varchar2(10 char),
  p_prefix_prc                  varchar2(10 char)
  );
